...
git remote add github https://$GITHUB_TOKEN@github.com/cjfff/online-vue-editor.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/cjfff/online-vue-editor/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "online-vue-editor更新", "text": "@所有人\n# [online-vue-editor('$version')]('$html_url')\n'$body'"}}'
